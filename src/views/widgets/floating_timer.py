...
from src.models.models import TimerRecord
...
class FloatingTimer(QWidget):
    ...
    def stop_timer(self):
        ...
        from src.views.widgets.save_record_dialog import SaveRecordDialog
    ...
    def show_history(self):
        from src.views.timer_history_view import TimerHistoryView
