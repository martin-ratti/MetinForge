...
from app.domain.models import (
    ...
    TombolaActivity, TombolaEvent, TombolaItemCounter
)

class MockTombolaService(TombolaService):
    def __init__(self, session):
        # Usamos la sesion directa sin proxy para diagnosticar
...
class TestTombolaIntegration:
    ...
    def test_get_events(self, tombola_ctrl, test_db, seed_data):
        ...
        test_db.commit() # Forzar persistencia para el query siguiente
